...
describe('isHttpError', () => {
  ...
  it('should return true for any error object that has a httpCode property', () => {

    const foo = new Error('hi');
    (<any>foo).httpCode = 404;
