      ...
      switch (code as any) {
        ...
        case 503:
          it('should respect the retryAfter parameter', () => {
            const obj2 = new (clss as any)('Foo', 600);
